...
export class TerraformImportHandler implements IHandleCommandString{
    ...
    private async setupVars(command: TerraformImport, terraform: ToolRunner){
    ...
    private setupAzureRmProvider(command: TerraformImport, terraform: ToolRunner){
