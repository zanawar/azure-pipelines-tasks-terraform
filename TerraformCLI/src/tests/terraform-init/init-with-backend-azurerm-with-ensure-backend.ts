...
new TaskScenario<TerraformInputs>()
    ...
    .answerAzCommandIsSuccessfulWithResult(new AzStorageContainerCreate(env.backendContainerName, env.backendStorageAccountName, env.backendKey), <AzStorageAccountCreateResult>{})
    .run()
