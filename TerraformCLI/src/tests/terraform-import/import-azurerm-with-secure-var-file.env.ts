...
const secureVarsFileName: string = "./.bin/tests/terraform-import/default.vars";
const resourceAddress = "azurerm_resource_group.rg"
const resourceId = "/subscriptions/sub1/resourceGroups/rg-tffoo-dev-eastus"
const expectedArgs = `-var-file=${secureVarsFileName} ${resourceAddress} ${resourceId}`
const expectedCommand: string = `${terraformCommand} ${expectedArgs}`

export let env: any = {
    taskScenarioPath: require.resolve('./import-azurerm-with-secure-var-file'),
    terraformCommand,
